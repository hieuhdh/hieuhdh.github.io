...
Ta có $\Big[\big(n-1\big) \ mod \ M \Big] \Big[\big(n+3\big) \ mod \ M \Big] = \Big[\big(n-1\big) \ mod \ M \Big] \Big[\big(n \ mod \ M +3\big) \ mod \ M \Big]$. Và đây chính thực sự là công thức ta cần tìm để có thể thỏa mãn yêu cầu đề bài. Hiển nhiên còn rất nhiều loại công thức khác có thể có cùng tính chất module tương tự nhưng vấn đề tôi nhấn mạnh ở công thức này là không được phép biến đổi làm tăng giá trị của $n$ khi nhập vào. Làm như thế về mặt lập trình là 1 lỗi cực kì quan trọng và dưới gốc độ của 1 attacker, họ sẽ tìm ra cách tấn công chương trình của bạn.
